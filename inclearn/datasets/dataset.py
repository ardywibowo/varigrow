...
class Places365(datasets.ImageFolder):
    ...
    def __init__(self, data_folder, train=True):
        super(Places365, self).__init__(data_folder, transform=self.train_transforms)
...
class TinyImageNet(datasets.ImageFolder):
    ...
    def __init__(self, data_folder, train=True):
        ...
        super(TinyImageNet, self).__init__(data_folder, transform=self.train_transforms)
        # self.base_dataset = datasets.ImageFolder(data_folder, transform=self.train_transforms)
