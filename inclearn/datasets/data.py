...
class IncrementalDataset:
    ...
    def new_task(self):
        ...
        self.classes_cur = np.unique(y_train)
        ...
        new_data_loader = self._get_loader(x_new, x_new, mode="train")
        ...
        return task_info, train_loader, val_loader, test_loader, new_data_loader
    ...
    def _get_loader(self, x, y, share_memory=None, shuffle=True, mode="train", batch_size=None, resample=None):
        ...
        if "train" in mode:
            ...
            if resample_ is False:
                ...
                raise RuntimeError('sampler = get_weighted_random_sampler(y) not implemented')
